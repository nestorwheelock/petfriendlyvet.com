//! Pet-Friendly Veterinary License Validator
//!
//! This binary validates license files for production deployments.
//! Called by Django during bootstrap to verify valid commercial license.
...
fn compute_signature(payload: &[u8]) -> String {
    ...
    hasher.update(b"pfv-license-salt-2025"); // Secret salt
